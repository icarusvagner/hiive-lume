...
use crate::{
	data::models::home_menu::HomeHeaderMenuModel, states::home_layout::HomeActiveLayout
};
	...
	pub fn all_data() -> Vec<HomeHeaderMenuModel> {
		vec![
			...
			HomeHeaderMenuModel::new(
				...
				Icon::new(
					Icon::empty()
						.path("icons/custom/list-box-check-outline.svg"),
				),
			...
			HomeHeaderMenuModel::new(
				"Leaves".to_string(),
				Icon::new(
					Icon::empty().path("icons/custom/text-box-outline.svg"),
				),
				HomeActiveLayout::Leaves,
			),
			HomeHeaderMenuModel::new(
				"Payroll".to_string(),
				Icon::new(Icon::empty().path("icons/custom/hand-coins.svg")),
				HomeActiveLayout::Payroll,
			),
		]
	}
}
