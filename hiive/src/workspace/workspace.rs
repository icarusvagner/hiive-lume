...
use crate::{
	states::show_layout::{ActiveLayout, LayoutState}, workspace::{
		footer::FooterBar, header::HeaderBar, home::HomeSpace, login::LoginSpace
	}
};
...
impl Workspace {
	pub fn new(window: &mut Window, cx: &mut Context<Self>) -> Self {
		...
		let _subscription =
			vec![cx.observe_global::<LayoutState>(move |this, cx| {
