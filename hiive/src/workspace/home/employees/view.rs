...
use crate::{
	states::{
		candidate_switch_state::{ActiveSwitchModeState, SwitchMode}, home_layout::HomeLayout
	}, workspace::home::employees::{
		card_mode::EmployeeCardMode, table_mode::EmployeeTableMode
	}
};
...
impl Employees {
	pub fn new(window: &mut Window, cx: &mut Context<Self>) -> Self {
		...
		Self {
			...
			card_mode,
			table_mode,
			switch_mode: SwitchMode::TableMode,
		}
	}
