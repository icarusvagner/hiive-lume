...
impl EmployeeTableDelegate {
    pub fn new() -> Self {
        ...
        let columns = vec![
            ...
            Column::new("emp-name", "Employee Name")
                .width(220.0)
                .sortable(),
            Column::new("emp-position", "Position")
                .width(325.0)
                .sortable(),
            ...
            Column::new("emp-department", "Department")
                .width(225.0)
                .sortable(),
...
impl TableDelegate for EmployeeTableDelegate {
    ...
    fn render_th(&self, col_ix: usize, _window: &mut Window, _cx: &mut App) -> impl IntoElement {
        ...
        match col.key.as_ref() {
            "checkbox" => {
                div().child(Checkbox::new("select_all_employee").checked(self.select_all))
            }
    ...
    fn render_td(
        ...
        match col.key.as_ref() {
            "checkbox" => div().child(Checkbox::new(SharedString::new(format!(
                "{}-row_checked",
                col_ix
            )))),
            "emp-name" => h_flex()
            ...
            "emp-department" => div().child(Label::new(emp.department().as_str())),
