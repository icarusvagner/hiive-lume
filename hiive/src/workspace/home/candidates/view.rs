...
use crate::{
    core::types::candidates_status::CandidateStatusType,
    data::home::interviews_data::InterviewsData,
    states::candidate_switch_state::{ActiveSwitchModeState, SwitchMode},
    workspace::home::candidates::{card_mode::CandidateCardModeView, table_mode::TableModeView},
};
