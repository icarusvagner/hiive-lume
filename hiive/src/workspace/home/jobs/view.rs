...
use crate::{
    core::types::gen_status::GeneralStatus,
    data::{jobs::JobsData, models::jobs_model::JobsModel},
    workspace::home::jobs::jobs_cards::JobCardsView,
};
...
impl Jobs {
    ...
    fn render_top_content(&self, _window: &mut Window, cx: &mut Context<Self>) -> Div {
        let total_jobs = self
            .data
            .iter()
            ...
            h_flex()
                ...
                .child(
                    v_flex()
                        ...
                        .child(
                            Label::new(format!("{total_jobs} Total active jobs"))
                                .text_lg()
