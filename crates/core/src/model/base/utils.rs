...
use tools::time::now_utc;

use crate::model::base::{CommonIden, DbBmc, TimestampIden};

/// This method must be called when a model controller intends to create its
/// entity.
...
/// This method must be calledwhen a Model Controller plans to update its
/// entity.
