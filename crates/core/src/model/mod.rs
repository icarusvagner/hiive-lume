...
//! Design:
//!
//! - The Model layer normalizes the application's data type structures and
//!   access.
...
//!   ModelControllers to access data. (e.g., db_pool, S3 client, redis client).
//! - Model Controllers (e.g., `ConvBmc`, `AgentBmc`) implement CRUD and other
//!   data access methods on a given "entity" (e.g., `Conv`, `Agent`). (`Bmc` is
//!   short for Backend Model Controller).
