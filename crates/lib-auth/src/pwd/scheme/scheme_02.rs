...
use argon2::{
	Algorithm, Argon2, Params, PasswordHash, PasswordHasher as _, PasswordVerifier as _, Version, password_hash::SaltString
};
...
mod tests {
	...
	fn test_scheme_02_hash_into_b64u_ok() -> Result<()> {
		...
		let fx_res = "$argon2id$v=19$m=19456,t=2,\
		              p=1$8F6JYdatQIaeeKbeBl5UUw$a+Q0oQEA534EZtk/\
		              TYrjemzST3+7OC4Ep7HwEYo4tA0";
